...
namespace Trakx.Tests.Integration.Common.Ethereum
{
    public class WrappingCreatorTest
    {
        ...
        {
            var transaction = new WrappingTransaction(DateTime.Now, null,null,TransactionState.Pending,null,null,null,null,.20m,null, "0x9d9fFD857c0B1908C961D2FB7E5a4fc5871FFCE1", null);
        ...
        public async Task BurnToken_should_burn_token_and_return_TransactionHash()
        {
            ...
            var transaction = new WrappingTransaction(DateTime.Now, null, null, TransactionState.Pending, null, null, null, null, 1.2456m,null, "0x191FC2305d6C98291E68a5bD23908D9036Aa0175", null);
        ...
        public async Task TotalSupply_should_return_correct_amount()
        {
            ...
            var mintTransaction = new WrappingTransaction(DateTime.Now, null, null, TransactionState.Pending, null, null, null, null, 2.20m, null, "0x191FC2305d6C98291E68a5bD23908D9036Aa0175", null);
