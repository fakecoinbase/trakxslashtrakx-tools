...
namespace Trakx.IndiceManager.ApiClient
{
    ...
    public partial interface IAddressMappingClient
    {
        /// <summary>Get one trakx address on coinbase for currencySymbol.</summary>
        ...
        System.Threading.Tasks.Task<Response<string>> GetTrakxAddressAsync(string currencySymbol);
        ...
        /// <returns>Trakx address for currencySymbol.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<string>> GetTrakxAddressAsync(string currencySymbol, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Get symbols of all trakx wallets available on coinbase.</summary>
        /// <returns>List of symbols.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<System.Collections.Generic.List<string>>> GetAllSymbolAvailableOnCoinbaseAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Get symbols of all trakx wallets available on coinbase.</summary>
        /// <returns>List of symbols.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<System.Collections.Generic.List<string>>> GetAllSymbolAvailableOnCoinbaseAsync(System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    internal partial class AddressMappingClient : AuthorisedClient, IAddressMappingClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public AddressMappingClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
        ...
        /// <returns>Trakx address for currencySymbol.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response<string>> GetTrakxAddressAsync(string currencySymbol)
        {
            return GetTrakxAddressAsync(currencySymbol, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Trakx address for currencySymbol.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response<string>> GetTrakxAddressAsync(string currencySymbol, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/AddressMapping/GetTrakxAddress?");
        ...
        /// <returns>List of symbols.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response<System.Collections.Generic.List<string>>> GetAllSymbolAvailableOnCoinbaseAsync()
        {
            return GetAllSymbolAvailableOnCoinbaseAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>List of symbols.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response<System.Collections.Generic.List<string>>> GetAllSymbolAvailableOnCoinbaseAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/AddressMapping/GetAllSymbolAvailableOnCoinbase");
                ...
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            return new Response<System.Collections.Generic.List<string>>((int)response_.StatusCode, headers_, objectResponse_.Object);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
                        ...
                        return new Response<System.Collections.Generic.List<string>>((int)response_.StatusCode, headers_, default(System.Collections.Generic.List<string>)); 
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<Response> RegisterUserAsAddressOwnerAsync(DepositAddressModel claimedAddress, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/AddressMapping/RegisterUserAsAddressOwner");
            ...
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(claimedAddress, _settings.Value));
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial interface IAuthentificationClient
    {
        /// <summary>Use this route to get information about the bearer issued during the request.</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<string>> GetBearerTokenAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Use this route to get information about the bearer issued during the request.</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<string>> GetBearerTokenAsync(System.Threading.CancellationToken cancellationToken);
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    internal partial class AuthentificationClient : AuthorisedClient, IAuthentificationClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public AuthentificationClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        ...
        /// <summary>Use this route to get information about the bearer issued during the request.</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response<string>> GetBearerTokenAsync()
        {
            return GetBearerTokenAsync(System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Use this route to get information about the bearer issued during the request.</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response<string>> GetBearerTokenAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Authentification/GetBearerToken");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    internal partial class IndiceCreationClient : AuthorisedClient, IIndiceCreationClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    internal partial class IndiceSupplyClient : AuthorisedClient, IIndiceSupplyClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    ...
    public partial interface IWrappingClient
    {
        ...
        /// <returns>Return a BadRequest object if the information in  are wrong.
        ...
        /// <summary>This route allows to retrieve the Trakx' balance, either with native or wrapped tokens.</summary>
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<System.Collections.Generic.List<AccountBalanceModel>>> GetTrakxBalancesAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>This route allows to retrieve the Trakx' balance, either with native or wrapped tokens.</summary>
        /// <returns>An Ok object list composed by all the balances with status 200 or a InternalServerError object if it failed.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response<System.Collections.Generic.List<AccountBalanceModel>>> GetTrakxBalancesAsync(System.Threading.CancellationToken cancellationToken);
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.6.0.0 (NJsonSchema v10.1.18.0 (Newtonsoft.Json v12.0.0.0))")]
    internal partial class WrappingClient : AuthorisedClient, IWrappingClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
        ...
        /// <returns>An Ok object list composed by all the balances with status 200 or a InternalServerError object if it failed.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response<System.Collections.Generic.List<AccountBalanceModel>>> GetTrakxBalancesAsync()
        {
            return GetTrakxBalancesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>An Ok object list composed by all the balances with status 200 or a InternalServerError object if it failed.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response<System.Collections.Generic.List<AccountBalanceModel>>> GetTrakxBalancesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Wrapping/GetTrakxBalances");
    ...
    public partial class DepositAddressModel 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.RegularExpression(@"[\w]{10,}")]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class ComponentDetailModel 
    {
        ...
        [Newtonsoft.Json.JsonProperty("coinGeckoId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class IndiceDetailModel 
    {
        [Newtonsoft.Json.JsonProperty("symbol", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public string Symbol { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("indiceState", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("naturalUnit", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int NaturalUnit { get; set; }
    
        [Newtonsoft.Json.JsonProperty("indiceCompositions", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<IndiceCompositionModel> IndiceCompositions { get; set; }
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class IndiceCompositionModel 
    {
        [Newtonsoft.Json.JsonProperty("indiceDetail", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public System.Collections.Generic.List<ComponentDetailModel> Components { get; }
    
        [Newtonsoft.Json.JsonProperty("version", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Version { get; set; }
    
        [Newtonsoft.Json.JsonProperty("targetedNav", Required = Newtonsoft.Json.Required.Always)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class IndiceSupplyTransactionModel 
    {
        ...
        [Newtonsoft.Json.JsonProperty("indiceComposition", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("indiceQuantity", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("ethereumBlockId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class WrappingTransactionModel 
    {
        [Newtonsoft.Json.JsonProperty("trakxAddress", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TrakxAddress { get; set; }
    
        [Newtonsoft.Json.JsonProperty("senderAddress", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SenderAddress { get; set; }
    
        [Newtonsoft.Json.JsonProperty("receiverAddress", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("toCurrency", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ToCurrency { get; set; }
    
        [Newtonsoft.Json.JsonProperty("ethereumBlockId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? EthereumBlockId { get; set; }
    
        [Newtonsoft.Json.JsonProperty("nativeBlockId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? NativeBlockId { get; set; }
    
        [Newtonsoft.Json.JsonProperty("ethereumTransactionHash", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EthereumTransactionHash { get; set; }
    
        [Newtonsoft.Json.JsonProperty("nativeChainTransactionHash", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class AccountBalanceModel 
    {
        [Newtonsoft.Json.JsonProperty("symbol", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Symbol { get; set; }
        ...
        public long NativeBalance { get; set; }
