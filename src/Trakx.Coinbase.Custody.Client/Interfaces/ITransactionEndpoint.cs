...
namespace Trakx.Coinbase.Custody.Client.Interfaces
{
    ...
    public interface ITransactionEndpoint
    {
        ...
        Task<PagedResponse<Transaction>> ListTransactionsAsync(string? currency = null, string? state = null, string? walletId = null, string? type = null, string? startTime = null, string? endTime = null, CancellationToken cancellationToken = default);
